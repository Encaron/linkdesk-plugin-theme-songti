...
- 配方 id `songti-print` → `theme-songti.songti-print`
- 配色 id `paper` → `theme-songti.paper`
...
- 意象：右上折角纸页 + 一横一竖两笔墨，取宋体三处字形特征（横细竖粗 / 横的三角顿角 / 竖的悬针收笔）
...
- 极限壳主题·font 域——全 UI 宋体（SimSun）+ 纸白墨黑文档感
